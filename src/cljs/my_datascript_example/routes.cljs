(ns my-datascript-example.routes
  (:require [reitit.frontend :as rf]
            [reitit.frontend.easy :as rfe]
            [reitit.coercion.spec :as rss]
            [re-frame.core :as re-frame]
            [my-datascript-example.events :as events]
            [my-datascript-example.subs :as subs]
            [my-datascript-example.views.home.panel :refer [home-panel]]
            [my-datascript-example.views.about.panel :refer [about-panel]]))
