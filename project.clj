(defproject my-datascript-example "0.1.0-SNAPSHOT"
  ...
  {:dev     {:dependencies [[binaryage/devtools "0.9.10"]
   ...
   :uberjar {:source-paths       ["env/prod/clj"]
             ...
             :omit-source        true
             :main               my-datascript-example.server
             :aot                [my-datascript-example.server]
             :uberjar-name       "my-datascript-example.jar"
             :prep-tasks         ["compile" ["fig:prod"]]
             :uberjar-exclusions [#"devcards\.html"]}}
  :ring {:handler my-datascript-example.handler/app})
